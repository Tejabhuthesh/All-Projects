		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "MAPS",
									"targetURL": "#idmapszgeomap-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"idmapszgeomap-display": {
								"semanticObject": "idmapszgeomap",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=idmaps.zgeomap",
									"url": sap.ui.require.toUrl("idmaps/zgeomap")
								}
							}
						}
					}
