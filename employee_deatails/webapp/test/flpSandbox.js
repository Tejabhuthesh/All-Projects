		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#idEDemployeedeatails-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"idEDemployeedeatails-display": {
								"semanticObject": "idEDemployeedeatails",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=idED.employeedeatails",
									"url": sap.ui.require.toUrl("idED/employeedeatails")
								}
							}
						}
					}
