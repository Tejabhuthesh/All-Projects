		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Candidates ",
									"targetURL": "#candidatedeatailszcandidates-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"candidatedeatailszcandidates-display": {
								"semanticObject": "candidatedeatailszcandidates",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=candidate.deatails.zcandidates",
									"url": sap.ui.require.toUrl("candidate/deatails/zcandidates")
								}
							}
						}
					}
