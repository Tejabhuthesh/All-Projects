		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#idempzempsalary-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"idempzempsalary-display": {
								"semanticObject": "idempzempsalary",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=idemp.zempsalary",
									"url": sap.ui.require.toUrl("idemp/zempsalary")
								}
							}
						}
					}
