    ...
    function (Controller, MessageToast, MessageBox, JSONModel, BusyIndicator) {
        ...
        return Controller.extend("idcartonenquiry.zcartonenquiry.controller.Scanner", {
                    ...
                    if (oEvent.getParameter("text")) {
                        ...
                        oModel.read("/CodeScannerSet", {
                            ...
                            success: function (odata) {
                                ...
                                this.getView().setModel(oModel1, "ScanData");
                                ...
                                if (_HUNumber) {
                                    ...
                                    this.getView().setModel(oModel1, "ScanData1");
                                    let TS = [];
                                    ...
                                    this.byId("idTS").setValue(sum);
                                    this.getView().byId("sampleBarcodeScannerButtonChild").setVisible(true);
                                } else {
                                ...
                                this.getView().byId('idScanHere').setValue();
                                this.byId("idSO").setValue();
                            }.bind(this),
            ...
            onScanSuccessChild: function (oEvent) {
                ...
                var array1 = this.getView().getModel("ScanData").getData().results;
                        ...
                        if (_Data) {
                            ...
                            if (rdata1) {
                                ...
                                if (rdata2) {
                                    ...
                                    this.getView().getModel("ScanData1").setData(sData);
