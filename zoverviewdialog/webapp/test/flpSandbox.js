		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#zoverviewdialog-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zoverviewdialog-display": {
								"semanticObject": "zoverviewdialog",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zoverviewdialog",
									"url": sap.ui.require.toUrl("zoverviewdialog")
								}
							}
						}
					}
