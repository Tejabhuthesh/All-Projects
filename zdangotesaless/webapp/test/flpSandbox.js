		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Dangote Sales",
									"targetURL": "#iddsaleszdangotesaless-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"iddsaleszdangotesaless-display": {
								"semanticObject": "iddsaleszdangotesaless",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=iddsales.zdangotesaless",
									"url": sap.ui.require.toUrl("iddsales/zdangotesaless")
								}
							}
						}
					}
