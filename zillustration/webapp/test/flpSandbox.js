		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#idillustrationzillustration-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"idillustrationzillustration-display": {
								"semanticObject": "idillustrationzillustration",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=idillustration.zillustration",
									"url": sap.ui.require.toUrl("idillustration/zillustration")
								}
							}
						}
					}
