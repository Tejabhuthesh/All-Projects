		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#idnorthwindznorthwind-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"idnorthwindznorthwind-display": {
								"semanticObject": "idnorthwindznorthwind",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=idnorthwind.znorthwind",
									"url": sap.ui.require.toUrl("idnorthwind/znorthwind")
								}
							}
						}
					}
