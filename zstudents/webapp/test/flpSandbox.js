		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "student deatails",
									"targetURL": "#idstudentzstudents-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"idstudentzstudents-display": {
								"semanticObject": "idstudentzstudents",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=idstudent.zstudents",
									"url": sap.ui.require.toUrl("idstudent/zstudents")
								}
							}
						}
					}
