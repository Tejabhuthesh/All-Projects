		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "CRUD OPAREATIONS",
									"targetURL": "#idodataodatacrud-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"idodataodatacrud-display": {
								"semanticObject": "idodataodatacrud",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=idodata.odatacrud",
									"url": sap.ui.require.toUrl("idodata/odatacrud")
								}
							}
						}
					}
