		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#tabledraganddrop-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"tabledraganddrop-display": {
								"semanticObject": "tabledraganddrop",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=tabledraganddrop",
									"url": sap.ui.require.toUrl("tabledraganddrop")
								}
							}
						}
					}
