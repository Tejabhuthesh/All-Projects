		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "ZEMPLOYEE_EEE",
									"targetURL": "#idZEMPLOYEEEEEzemployeeeee-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"idZEMPLOYEEEEEzemployeeeee-display": {
								"semanticObject": "idZEMPLOYEEEEEzemployeeeee",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=idZEMPLOYEEEEE.zemployeeeee",
									"url": sap.ui.require.toUrl("idZEMPLOYEEEEE/zemployeeeee")
								}
							}
						}
					}
