		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#navigationdisplaymethod2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"navigationdisplaymethod2-display": {
								"semanticObject": "navigationdisplaymethod2",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=navigationdisplaymethod2",
									"url": sap.ui.require.toUrl("navigationdisplaymethod2")
								}
							}
						}
					}
