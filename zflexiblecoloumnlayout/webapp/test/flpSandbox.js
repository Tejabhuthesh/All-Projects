		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#flexidzflexiblecoloumnlayout-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"flexidzflexiblecoloumnlayout-display": {
								"semanticObject": "flexidzflexiblecoloumnlayout",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=flexid.zflexiblecoloumnlayout",
									"url": sap.ui.require.toUrl("flexid/zflexiblecoloumnlayout")
								}
							}
						}
					}
