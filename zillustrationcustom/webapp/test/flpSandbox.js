		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#zillustrationcustom-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zillustrationcustom-display": {
								"semanticObject": "zillustrationcustom",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zillustrationcustom",
									"url": sap.ui.require.toUrl("zillustrationcustom")
								}
							}
						}
					}
