		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#idgpcetzgpcet-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"idgpcetzgpcet-display": {
								"semanticObject": "idgpcetzgpcet",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=idgpcet.zgpcet",
									"url": sap.ui.require.toUrl("idgpcet/zgpcet")
								}
							}
						}
					}
