		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Titlle",
									"targetURL": "#idflexzflexiblecoloumn-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"idflexzflexiblecoloumn-display": {
								"semanticObject": "idflexzflexiblecoloumn",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=idflex.zflexiblecoloumn",
									"url": sap.ui.require.toUrl("idflex/zflexiblecoloumn")
								}
							}
						}
					}
