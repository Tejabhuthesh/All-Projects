		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Sale Orders",
									"targetURL": "#idsaleszsales-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"idsaleszsales-display": {
								"semanticObject": "idsaleszsales",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=idsales.zsales",
									"url": sap.ui.require.toUrl("idsales/zsales")
								}
							}
						}
					}
