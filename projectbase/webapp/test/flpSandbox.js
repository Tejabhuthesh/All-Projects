		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#idbaseprojectbase-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"idbaseprojectbase-display": {
								"semanticObject": "idbaseprojectbase",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=idbase.projectbase",
									"url": sap.ui.require.toUrl("idbase/projectbase")
								}
							}
						}
					}
