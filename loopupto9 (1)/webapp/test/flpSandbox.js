		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "forloop Title",
									"targetURL": "#id9loopupto9-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"id9loopupto9-display": {
								"semanticObject": "id9loopupto9",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=id9.loopupto9",
									"url": sap.ui.require.toUrl("id9/loopupto9")
								}
							}
						}
					}
