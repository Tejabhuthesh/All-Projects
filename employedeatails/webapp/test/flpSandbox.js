		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#idemployeedemployedeatails-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"idemployeedemployedeatails-display": {
								"semanticObject": "idemployeedemployedeatails",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=idemployeed.employedeatails",
									"url": sap.ui.require.toUrl("idemployeed/employedeatails")
								}
							}
						}
					}
