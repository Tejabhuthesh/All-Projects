...
//         return Controller.extend("idemployeed.employedeatails.controller.View1", {
//             onInit: function () {
    ...
    function (Controller,JSONModel, MessageToast, FilterOperator, Filter, MessageBox, exportLibrary, Spreadsheet) {
        ...
        return Controller.extend("idemployeed.employedeatails.controller.View1", {
            onInit: function () {
                ...
                var oModel = new ODataModel("/sap/opu/odata/SAP/ZTESTING2PROJECT_SRV/EmployeeDeatailsSet");
