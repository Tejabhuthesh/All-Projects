		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#idsalaryzemploysalary-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"idsalaryzemploysalary-display": {
								"semanticObject": "idsalaryzemploysalary",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=idsalary.zemploysalary",
									"url": sap.ui.require.toUrl("idsalary/zemploysalary")
								}
							}
						}
					}
