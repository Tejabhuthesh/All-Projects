		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#navigationdisplaymethod-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"navigationdisplaymethod-display": {
								"semanticObject": "navigationdisplaymethod",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=navigationdisplaymethod",
									"url": sap.ui.require.toUrl("navigationdisplaymethod")
								}
							}
						}
					}
