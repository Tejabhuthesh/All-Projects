		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#idScannerzscanner-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"idScannerzscanner-display": {
								"semanticObject": "idScannerzscanner",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=idScanner.zscanner",
									"url": sap.ui.require.toUrl("idScanner/zscanner")
								}
							}
						}
					}
